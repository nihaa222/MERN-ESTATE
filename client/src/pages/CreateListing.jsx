    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              <input
                ...
                max="10"
                required
                className="p-3 border vorder-gray-300 rounded-lg"
              />
              <p>Beds</p>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <button className="p-3 bg-slate-700 mt-2 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-8">
            create listing{" "}
          </button>
        </div>
      </form>
